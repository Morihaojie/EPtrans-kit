...
class Interface():
    ...
    def get_item_from_force_constants_arrays(self,m,n,force_constants_arrays):
    ...
    def get_item_from_numpy_matrix(self,m,n,force_constants_numpy_matrix):
    ...
    def get_symmetrize_matrix_abandon(self,input_matrix):
    ...
    def reshape(self,reordered_coordinates_arrays,coordinates_arrays):
    ...
    def reshape_for_frc_gulp(self,reordered_coordinates_arrays,coordinates_arrays):
        reordered_coordinates_arrays = reordered_coordinates_arrays[:,1:].astype(float)
    ...
    def repeat_coordinates_arrays(self,repeat_times,coordinates_arrays,lattice_parameters):
    ...
    def repeat_coordinates_arrays_and_lattice_parameters_from_py(self,repeat_times,coordinates_arrays,lattice_parameters):
        repeat_times_num = int(repeat_times[0])*int(repeat_times[1])*int(repeat_times[2])
    ...
    def repeat_coordinates_arrays_and_lattice_parameters_from_pos(self,repeat_times,coordinates_arrays,lattice_parameters):
        repeat_times_num = int(repeat_times[0])*int(repeat_times[1])*int(repeat_times[2])
        repeated_coordinates_arrays = np.zeros((len(coordinates_arrays)*repeat_times_num,3))
        elements = []
        atoms_num = len(coordinates_arrays)
    ...
    def trans_force_constants_arrays_to_force_constants(self,force_constants_arrays):
    ...
    def trans_element_to_relative_atomic_mass(self,element):
        if element == 'C':
    ...
    def trans_relative_atomic_mass_or_element_full_name_to_element(self,input_data):
    ...
    def trans_element_full_name_or_element_to_accurate_relative_atomic_mass_atk(self,input_data):
    ...
    def gen_replaceable_tag_list(self,fix_tag_list):
    ...
    def gen_replaceable_list(self,fix_tag_list):
    ...
    def trans_element_relative_atomic_mass(self,element,replaceable_tag):
    ...
    def trans_element_relative_atomic_mass_by_index(self,elements,index):
    ...
    def trans_coordinates_arrays_to_pos(self,coordinates_arrays,lattice_parameters,filename):
        coordinates_arrays = coordinates_arrays.astype(str)
    ...
    def trans_coordinates_arrays_from_py_to_pos(self,coordinates_arrays,lattice_parameters,filename):
        coordinates_arrays = coordinates_arrays.astype(str)
        lattice_parameters = lattice_parameters.astype(str)        
        with open(filename, 'w') as file_object:
            file_object.write('global'+'\n')
    ...
    def trans_coordinates_arrays_to_cif(self,coordinates_arrays,lattice_parameters,filename):
    ...
    def rotate_coordinates_arrays(self,coordinates_arrays,theta):
